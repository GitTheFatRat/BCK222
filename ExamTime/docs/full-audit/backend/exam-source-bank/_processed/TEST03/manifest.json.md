# backend/exam-source-bank/_processed/TEST03/manifest.json

## Muc dich (1-2 cau)
File JSON này là tờ khai (Manifest) tóm tắt các thông tin siêu dữ liệu (metadata) của bộ đề thi (ví dụ: mã đề, tên đề, nguồn gốc).
