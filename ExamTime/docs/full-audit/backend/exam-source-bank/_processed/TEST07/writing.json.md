# backend/exam-source-bank/_processed/TEST07/writing.json

## Muc dich (1-2 cau)
File JSON này chứa dữ liệu gốc cho phần thi Writing, cung cấp đề bài cho Task 1 (Mô tả biểu đồ/hình ảnh) và Task 2 (Viết bài luận).
