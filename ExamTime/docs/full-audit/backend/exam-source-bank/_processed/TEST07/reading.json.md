# backend/exam-source-bank/_processed/TEST07/reading.json

## Muc dich (1-2 cau)
File JSON này chứa dữ liệu gốc cho phần thi Reading. Bao gồm các bài văn (Passage), danh sách câu hỏi theo từng bài, và đáp án.
