# backend/exam-source-bank/_processed/TEST06/listening.json

## Muc dich (1-2 cau)
File JSON này chứa dữ liệu gốc (Raw Data) cho phần thi Listening của bộ đề. Nó bao gồm danh sách các đoạn audio, các câu hỏi trắc nghiệm/điền từ, và đáp án (cùng lời giải thích).
