# backend/exam-source-bank/_processed/TEST09/speaking.json

## Muc dich (1-2 cau)
File JSON này chứa dữ liệu gốc cho phần thi Speaking, thường là danh sách các câu hỏi Part 1, đề bài Part 2 (Cue Card) và các câu hỏi Part 3.
